...
/*users
*/
INSERT INTO Users (clubAdmin, nkpag, siteAdmin, username, email, password, blocked)
VALUES (0, 0, 1, "site", "admin123@rgu.ac.uk", "site1", 0),
(0, 1, 0, "map", "map123@rgu.ac.uk", "map1", 0),
(1, 0, 0, "golf", "golf123@rgu.ac.uk", "golf1", 0),
(1, 0, 0, "soccer", "soccer123@rgu.ac.uk", "soccer1", 0),
(1, 1, 0, "combined", "combined123@rgu.ac.uk", "combined1", 0),
(0, 0, 0, "simple", "user123@rgu.ac.uk", "simple1", 0),
(0, 0, 0, "simple2", "user2000@rgu.ac.uk", "simple22", 0),
(0, 0, 0, "simple3", "user3000@rgu.ac.uk", "simple33", 1),
(1, 0, 0, "golf2", "golf2000@rgu.ac.uk", "golf22", 1);
...
/*clubevents
*/
INSERT INTO ClubEvents (club_id, user_id, approvedBy, name, description, eventDate, approved)
VALUES (1, 3, 3, "100th ANNIVERSARY GAME", "Aenean volutpat tristique dapibus. Donec tempor nulla leo, nec aliquam purus feugiat id. Duis id varius orci, a.", "2016-12-01 12:00:00", 1),
(1, 3, 3, "AfterParty Games", "Nullam tempor blandit augue quis viverra. Nam sit amet orci vitae.", "2016-12-02 00:00:00", 1),
(1, 6, 3, "PreParty Games", "Nam rhoncus rhoncus massa quis commodo. Nullam hendrerit malesuada tortor, quis.", "2016-11-30 18:30:00", 1),
(2, 6, 5, "Unusual activity day", "Vivamus egestas vel ligula eget mollis. Donec sit amet quam turpis. Vestibulum eu nulla rhoncus, consectetur lorem sed, laoreet purus. Nulla luctus egestas elit nec ullamcorper. Pellentesque eu eros.", "2016-12-01 00:00:00", 1),
(4, 7, NULL, "Friendly game - December", "
Etiam venenatis enim lorem, non consectetur lectus bibendum id.", "2016-12-05 13:30:00", 0),
(4, 2, 1, "Friendly game - November", "Donec convallis dapibus lectus at pellentesque. Integer euismod lectus.", "2016-11-26 13:30:00", 1);
...
Sed eget lacus lobortis, accumsan mauris ut, malesuada sapien. Integer vel quam justo. Sed mollis risus nulla. Fusce congue mi nunc, in tristique lacus eleifend ut. Cras in ipsum at leo bibendum condimentum. Phasellus at orci nisl. Nam varius quam et eros pretium euismod.", "2016-11-22 10:07:51", 1),
...
(9, NULL, "Old House", "", 57.060047, -2.129781, "Bruntland Road, Portlethen, Aberdeen AB12 4UT, UK", 0),
(7, NULL, "Nice Tree", "", 57.057422, -2.130447, "Portlethen Community Woodland Park", 0),
(1, 1, "Nice Bush", "", 57.056833, -2.130876, "Portlethen Community Woodland Park", 1);
...
*/
INSERT INTO Routes (user_id, approvedBy, name, description, coordinates, approved)
